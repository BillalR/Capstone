...
class calibrationScreen13:
    ...
    def __init__(self,master):
        ...
        self.blankSpace = ttk.Label(self.calibFrame,
                                                 text="We are now moving to the SELECT thought pattern processes.",
        ...
        self.fifthStateReadButton = ttk.Button(self.calibFrame,
                                                    text="Start",
                                                    style="unpressed.TButton")
        self.fifthStateReadButton.grid(column=25,row=8,columnspan=1,rowspan=1,padx=30)
