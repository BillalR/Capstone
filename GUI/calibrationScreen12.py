...
class calibrationScreen12:
    ...
    def __init__(self,master):
        ...
        self.blankSpace = ttk.Label(self.calibFrame,
                                                 text="We are now moving to the RIGHT thought pattern processes.",
        ...
        self.fourthStateReadButton = ttk.Button(self.calibFrame,
                                                    text="Start",
                                                    style="unpressed.TButton")
        self.fourthStateReadButton.grid(column=25,row=8,columnspan=1,rowspan=1,padx=30)
